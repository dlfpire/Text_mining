...
# 검색하고 싶은 단어
search_word = "airpods pro"

# 검색하는 기간
start_day = "2022-10-08"
end_day = "2022-10-14"
...
df = df[df['content'].str.contains('airpodspro|Airpods Pro|Airpods pro|airpods Pro|AirpodsPro|airpodsPro')]
...
# print(stop_words)
stop_words.extend(["rt", 'airpods', 'pro', 'airpodspro', 'airpods pro'])  ###여기서 필요한 stopwords추가
# print(stop_words)
